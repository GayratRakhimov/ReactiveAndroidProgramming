...
import static com.gayratrakhimov.reactiveandroidprogramming.TimingObservableTransformer.timeItems;
import static com.gayratrakhimov.reactiveandroidprogramming.storio.LocalItemPersistenceHandlingTransformer.addLocalItemPersistenceHandling;
...
public class MainActivity extends RxAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable.merge(
                createFinancialStockUpdateObservable(coinApiService, query, env),
...
//    }
    ...
    private Observable<StockUpdate> createFinancialStockUpdateObservable(CoinApiService coinApiService, String query, String env) {
        return coinApiService.getExchangeRates("USD")
